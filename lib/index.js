...
var isEmail = function isEmail(value) {
  ...
  var isValid = _validator2.default.isEmail(value, { protocols: ['mailto'] });
  if (isValid) {
    return 'mailto:' + value;
  }
...
var isWebUrl = function isWebUrl(value) {
  ...
  if (!_validator2.default.isURL(value)) {
...
exports.default = { isEmail: isEmail, isTel: isTel, isWebUrl: isWebUrl, isValidUrl: isValidUrl };
